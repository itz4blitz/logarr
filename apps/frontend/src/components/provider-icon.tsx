...
function LidarrIcon({ className }: { className?: string }) {
  return (
    ...
    >
      ...
      <path d="M50 25v8M50 67v8M25 50h8M67 50h8" stroke="white" strokeWidth="4" strokeLinecap="round"/>
    </svg>
  );
}
...
function ReadarrIcon({ className }: { className?: string }) {
  return (
    ...
    >
      ...
      <path d="M35 35h30M35 45h30M35 55h20" stroke="#8B0000" strokeWidth="3" strokeLinecap="round"/>
    </svg>
  );
}
